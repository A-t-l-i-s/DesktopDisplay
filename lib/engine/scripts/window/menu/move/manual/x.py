...
__all__ = ("Scripts_Window_Menu_Move_Manual_X",)





class Scripts_Window_Menu_Move_Manual_X(RFT_Object, QWidgetAction):
	...
	def reload(self):
		self.valueWidget.setPlaceholderText(str(self.window.x))
