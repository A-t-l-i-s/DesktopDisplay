...
__all__ = ("Scripts_Window_Menu_Move_Manual_Width",)





class Scripts_Window_Menu_Move_Manual_Width(RFT_Object, QWidgetAction):
	...
	def reload(self):
		self.valueWidget.setPlaceholderText(str(self.window.width))
