...
__all__ = ("Window_Settings_Tabs_Window_Info_Threads",)





class Window_Settings_Tabs_Window_Info_Threads(RFT_Object, QFrame):
	def __init__(self, parent):
		...
		self.labelWidget.setText("Threads:")
	...
	def reload(self):
		self.inputWidget.setText(f"{threading.active_count()}")
