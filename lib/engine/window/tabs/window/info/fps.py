...
__all__ = ("Window_Settings_Tabs_Window_Info_FPS",)





class Window_Settings_Tabs_Window_Info_FPS(RFT_Object, QFrame):
	...
	def reload(self):
		self.inputWidget.setText(
			f"{self.parent.parent.parent.parent.parent.timer.rate:.2f}"
		)
